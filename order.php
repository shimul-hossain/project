...
<div class="container">
    ...
    <div class="col-6">
        <h1 class="text-center my-3 display-5">Welcome to buy a product</h1>
        <hr>
      <div class="container border my-3">
      <table class="w-100 my-3 text-center mx-auto">
        <tr>
        <td class="display-5"><?php echo $p_description; ?>:</td>
        <td class="w-50"><img class="img-thumbnail" src="images/<?php echo $product_img; ?>" width="220" height="150" alt="Image Not Found"></td>
        </tr></table>
        </div>

        <h1 class="display-4 text-center border">Price: &#36;<?php echo $product_price; ?></h1>
        
        <p>
  <a class="btn btn-outline-info w-100 " data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
  See Details
  </a>
</p>
<div class="collapse" id="collapseExample">
  ...
  <table class="table table-striped">
    ...
    <tr>
        ...
        <button class="btn btn-outline-success w-100 my-3">Add to Card</button>
